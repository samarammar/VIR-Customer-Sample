...
public class Utils {
    ...
    public static void compareValidDate(TextView myDate, LinearLayout layMyDate, Context context) {

        try {

            SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyy");
            long expDate = sdf.parse(myDate.getText().toString()).getTime();

            if (expDate < DateUtils.getCurrentTime()) {

                layMyDate.setBackgroundColor(ContextCompat.getColor(context, R.color.red));
    ...
    public static void compareValidDate(TextView myDate, FrameLayout layMyDate, Context context) {
    ...
    public static void compareValidDate(TextView myDate, LinearLayout layMyDate, LinearLayout layNotify, Context context) {
        ...
        try {
            ...
            if (expDate < DateUtils.getCurrentTime()) {
                ...
                layMyDate.setBackgroundColor(ContextCompat.getColor(context, R.color.red));
                layNotify.setVisibility(View.VISIBLE);
            } else {

                layNotify.setVisibility(View.GONE);
            }
    ...
    public static void cacheFirebaseToken(Context ctx,String key,String value){
        SharedPreferences prefs= ctx.getSharedPreferences(Const.FIREBASE_SHAREPREFERENCE, Context.MODE_PRIVATE);
        prefs.edit().putString(key, value).apply();
    }

    public static String getCachedFirebaseToken(Context ctx,String k, String defaultValue){
        SharedPreferences prefs= ctx.getSharedPreferences(Const.FIREBASE_SHAREPREFERENCE, Context.MODE_PRIVATE);
        return prefs.getString(k, defaultValue);
    }
    /**
